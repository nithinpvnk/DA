...
Parser* ConfigParseToConsole::Build()
{
	try
	{
		...
		// Class and Namespace
		pClassNameSpace = new ClassNamespaceDefinition;
		...
		//Try and Do
		pTryDo = new TryDoBlocks;
		pPushTryDo = new PushTryDo(pRepo);
		//pPrintTryDo = new PrintTryDo(pRepo);
		pParser->addRule(pTryDo);
		//pTryDo->addAction(pPrintTryDo);
		pTryDo->addAction(pPushTryDo);

		//Special Block
		pSplBlock = new SpclBlockDefinition;
		pPushSplBlock = new PushSpclBlock(pRepo);
		//pPrintSplBlock = new PrintSplBlock(pRepo);
		pParser->addRule(pSplBlock);
		//pSplBlock->addAction(pPrintSplBlock);
